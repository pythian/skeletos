...
// These definitions only export interfaces and types for Express so that isomorphic code does not have to import
// express on the client side.
...
export type ErrorRequestHandler = (err: any, req: Express.Request, res: Express.Response, next: NextFunction) => any;
...
export interface Response extends Express.Response {
    ...
    header(field: string, value?: string): Express.Response;
     ...
     */
    cookie(name: string, val: string, options: CookieOptions): Express.Response;
    cookie(name: string, val: any, options: CookieOptions): Express.Response;
     ...
     *
     */
    vary(field: string): Express.Response;
     ...
     * @since 4.11.0
     */
    append(field: string, value?: string[]|string): Express.Response;
}

export interface Handler extends RequestHandler { }

export type RequestParamHandler = (req: Express.Request, res: Express.Response, next: NextFunction, value: any, name: string) => any;
...
export interface Application extends IRouter {
     ...
     */
    listen(port: number, hostname: string, backlog: number, callback?: Function): any;
    listen(port: number, hostname: string, callback?: Function): any;
    listen(port: number, callback?: Function): any;
    listen(path: string, callback?: Function): any;
    listen(handle: any, listeningListener?: Function): any;
